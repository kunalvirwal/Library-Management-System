...
CREATE TABLE BOOKS( BUID INT PRIMARY KEY AUTO_INCREMENT, NAME VARCHAR(50) NOT NULL, DESCRIPTION varchar(2000),TOTAL INT NOT NULL, CHECKIN INT NOT NULL );

CREATE TABLE USER( UUID INT PRIMARY KEY AUTO_INCREMENT, NAME VARCHAR(50), EMAIL VARCHAR(50) UNIQUE NOT NULL, PHN_NO BIGINT, PASSWORD VARCHAR(100), ROLE VARCHAR(10),ADMIN_REQUEST BOOLEAN NOT NULL DEFAULT 0 );
